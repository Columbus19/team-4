...
class App extends React.Component {
  ...
  render() {
    ...
    var link = React.createElement('a', {href: '../..templates/profileaccepted.html'}, "Back")
...
class BotBubble extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "componentDidMount",
  ...
  render() {
    ...
    return (
      ...
      React.createElement("img", { className: "bot-avatar", src: "https://cdn.dribbble.com/users/279657/screenshots/2701628/chatbot.png", alt: "bot" })),
